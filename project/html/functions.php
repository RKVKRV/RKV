...
require_once ("C:\OpenServer\domains\RKV\project\data\menu.php");
require_once 'C:\OpenServer\domains\RKV\project\data\categories.php';
require_once 'C:\OpenServer\domains\RKV\project\data\products.php';
